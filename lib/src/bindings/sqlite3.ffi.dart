...
class SQLite3 {
  ...
  SQLite3(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;
  ...
  late final _sqlite3_txn_state_ptr =
      _lookup<ffi.NativeFunction<_c_sqlite3_txn_state>>('sqlite3_txn_state');
  late final _dart_sqlite3_txn_state _sqlite3_txn_state =
      _sqlite3_txn_state_ptr.asFunction<_dart_sqlite3_txn_state>();
...
const String SQLITE_SOURCE_ID =
    '2021-01-20 14:10:07 10e20c0b43500cfb9bbc0eaa061c57514f715d87238f4d835880cd846b9ealt1';
...
typedef _c_sqlite3_txn_state = ffi.Int32 Function(
  ffi.Pointer<sqlite3> arg0,
  ffi.Pointer<ffi.Int8> zSchema,
);

typedef _dart_sqlite3_txn_state = int Function(
  ffi.Pointer<sqlite3> arg0,
  ffi.Pointer<ffi.Int8> zSchema,
);
